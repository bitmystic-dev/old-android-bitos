      ...
      >
        <div className="bitos-titlebar">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm">auth.shell — login</span>
          </div>
        ...
        <div className="p-6 sm:p-8">
          <div className="mb-6">
            ...
            <div className="font-mono text-xs opacity-70 mt-1 cursor-blink">authenticate operator</div>
          </div>
          ...
          <form onSubmit={submit} className="space-y-3">
            <label className="block">
              ...
              <input
                ...
                placeholder="operator@bitos.dev"
              />
            </label>
            <label className="block">
              <div className="font-mono text-[11px] opacity-70 mb-1">$ password</div>
              <input
